...
| [`.daedalus/outcome-map.md`](outcome-map.md) | all | 全程导航：最终产物、当前位置、demo 缺口、依赖和停止规则 | 已验证 |
...
| [`guides/06-code-reader/README.md`](../guides/06-code-reader/README.md) | 06-code-reader | code-reader 阶段指南入口，索引待回答问题和待验证源码路径 | 已验证 |
| [`guides/06-code-reader/runtime-request-assembly.md`](../guides/06-code-reader/runtime-request-assembly.md) | 06-code-reader | Runtime request assembly 的 7 个第一性原理阅读问题 | 草稿 |
| [`guides/06-code-reader-guide.md`](../guides/06-code-reader-guide.md) | 06-code-reader | legacy：auth/approval/sandbox 专题的旧单文件阅读指南 | 草稿 |
| [`notes/06-code-reader/README.md`](../notes/06-code-reader/README.md) | 06-code-reader | code-reader 阶段 notes 入口，索引已验证专题和剩余 demo 缺口 | 已验证 |
| [`notes/06-code-reader/runtime-request-assembly.md`](../notes/06-code-reader/runtime-request-assembly.md) | 06-code-reader | Runtime request assembly 专题笔记，记录用户回答、源码校准和 demo delta | 已验证 |
| [`notes/06-code-reader/orchestrator-retry.md`](../notes/06-code-reader/orchestrator-retry.md) | 06-code-reader | Orchestrator retry 专题笔记，记录 sandbox denied 后 no-sandbox retry 状态机 | 已验证 |
| [`notes/code-reading.md`](../notes/code-reading.md) | 06-code-reader | legacy：核心代码阅读旧单文件综合笔记，保留历史结论和复盘 | 草稿 |
...
| [`notes/design-method-from-source-to-demo.md`](../notes/design-method-from-source-to-demo.md) | 07-demo-architecture | 从源码学习收敛到可迁移 mini demo 设计的方法论沉淀 | 已验证 |
| [`demo/design.md`](../demo/design.md) | 06-code-reader / 07-demo-architecture | mini demo 设计蓝图，包含 Phase 1/Phase 2、数据结构、状态机、事件协议和验收测试 | 已验证 |
| [`guides/08-demo-coder/README.md`](../guides/08-demo-coder/README.md) | 08-demo-coder | 08 阶段编码子地图，按 slice 实现 Phase 1 demo 并保留 Phase 2 runner 扩展位 | 草稿 |
| [`demo/Cargo.toml`](../demo/Cargo.toml) | 08-demo-coder | 用户创建的 Phase 1 mini demo 独立 Rust crate 配置 | 已验证 |
| [`demo/Cargo.lock`](../demo/Cargo.lock) | 08-demo-coder | 用户创建的 Phase 1 mini demo Rust 依赖锁文件 | 已验证 |
| [`demo/Makefile`](../demo/Makefile) | 08-demo-coder | 用户创建的 demo build/test 快捷入口 | 草稿 |
| [`demo/src/lib.rs`](../demo/src/lib.rs) | 08-demo-coder | 用户创建的 library 入口，当前包含 Slice 0 占位测试 | 已验证 |
| [`demo/src/main.rs`](../demo/src/main.rs) | 08-demo-coder | 用户创建的 binary 入口，当前输出 `Hello, world!` | 已验证 |
