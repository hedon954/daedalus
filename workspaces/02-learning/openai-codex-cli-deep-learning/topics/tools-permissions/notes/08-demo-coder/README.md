...
| Slice 8 event protocol design | [`05-slice-8-event-protocol-design.md`](05-slice-8-event-protocol-design.md) | 部分实现已验证 / command attempt 事件待透出 | 决定 command approval、command attempt、retry 事件和 broker-based approval 的落地方向 |
...
- [ ] Slice 8 完成：approval / command attempt / retry decision 等关键节点透出为外部可观察事件。
