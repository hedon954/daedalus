...
Phase 1 可以暂时不新增 `ToolRunDenied`。Slice 9 independent execution 第一版实现后没有找到真实 scheduler skip 场景，因此当前代码已删除 `ToolRuntimeResult::Skipped`，避免枚举状态膨胀。
