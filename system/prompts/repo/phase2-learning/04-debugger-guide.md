...
4. 将 Agent 生成的启动指南、预期输出和排障路径写入 `guides/04-debugger-guide/README.md`，复杂排障可拆到同目录专题文件。
5. 指导用户亲自运行最小命令，并把用户观察到的输出、错误和问题写入 `notes/04-debugger-guide/README.md` 或同目录 runbook 专题文件。
